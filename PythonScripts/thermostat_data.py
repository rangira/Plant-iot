...
#########################
            ...
            #print('hello')
#            print('Luminosity value = {luminosity}' .format(luminosity_t = luminosity_raw))
...
#    if trim_pot_changed:
        ...
        # set OS volume playback volume
            print('Moisture value = {moisture_t}' .format(moisture_t = moisture_raw))
            print('Luminosity value = {luminosity_t}' .format(luminosity_t = luminosity_raw))
#######################

            #temperature_msg1 = {"temperature": moisture}
